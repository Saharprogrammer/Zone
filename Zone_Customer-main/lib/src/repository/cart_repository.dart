...
Future<Cart> addCart(Cart cart, bool reset) async {
  ...
  final Uri url =  Uri.parse('${GlobalConfiguration().getValue('api_base_url')}carts?$_apiToken&$_resetParam');
  final client = new http.Client();
...
Future<Cart> updateCart(Cart cart) async {
  ...
  final String _apiToken = 'api_token=${_user.apiToken}';
  cart.userId = _user.id;
  final Uri url =  Uri.parse('${GlobalConfiguration().getValue('api_base_url')}carts/${cart.id}?$_apiToken');
  final client = new http.Client();
